...
.codetitle {
	...
	background: url(templates/subSilver/images/bbcode_code.gif) #009900 no-repeat right;
}
...
.quotetitle {
	...
	padding:5px; width:90%; font-weight:bold; text-align:left; margin-top:10px;
	background: url(templates/subSilver/images/bbcode_quote.gif) #7995DF no-repeat right;
}
