<!-- $Id: qpes_box.tpl,v 1.1 29/03/2006 15:46 reddog Exp $ -->
	...
	<table class="forumline" width="{QP_WIDTH}%" cellpadding="3" cellspacing="1" border="0">
	  ...
	  <tr>
	  	<td class="catBottom" align="center" height="28" colspan="2">
			...
			<!-- BEGIN qp_more -->
			<input type="button" tabindex="4" name="quoteselected" class="liteoption" value="{L_QUOTE_SELECTED}" onmousedown="quoteSelection()" />&nbsp;
			<!-- END qp_more -->
