...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post"><table width="98%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr>
	  ...
	  <td class="row2"><span class="genmed">{L_BDAY_DAY}:</span> {S_BDAY_DAY_OPTIONS} <span class="genmed">{L_BDAY_MONTH}:</span> {S_BDAY_MONTH_OPTIONS} <span class="genmed">{L_BDAY_YEAR}:</span> {S_BDAY_YEAR_OPTIONS}</td>
	</tr>
	<tr> 
	...
	<tr>
	  <td class="row1"><span class="gen">{L_COLORTEXT}</span>
	  <td class="row2">
		<input class="post" type="text" name="user_colortext" value="{COLORTEXT}" maxlength="7" />
	  </td>
	</tr>
	...
	<tr> 
	  ...
	  <td class="row2"> 
		<input type="radio" name="user_allowsignature" value="2" {ALLOW_SIGNATURE_YES_NOT_CONTROLED} /><span class="gen">{L_SIG_YES_NOT_CONTROLED}</span>&nbsp;
		<input type="radio" name="user_allowsignature" value="1" {ALLOW_SIGNATURE_YES_CONTROLED} /><span class="gen">{L_SIG_YES_CONTROLED}</span>&nbsp;
		<input type="radio" name="user_allowsignature" value="0" {ALLOW_SIGNATURE_NO} /><span class="gen">{L_NO}</span></td>
	</tr>
