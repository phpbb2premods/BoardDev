      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="bodyline">
        <tr> 
          ...
          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="forumline">
              <tr> 
                <th width="100%" nowrap class="thHead"><div align="center">{L_MODERATED}</div></th>
              </tr>
              <tr> 
          ...
          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="forumline">
              <tr> 
                <th width="100%" nowrap class="thHead"><div align="center">{L_AUTO_APPROVED}</div></th>
              </tr>
              <tr> 
                <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr> 
		...
		<tr> 
                  <th width="100%" nowrap class="thHead"><div align="center">{add_approval.L_ADD_APPROVAL_USER}</div></th>
                </tr>
                <tr> 
                  <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
                      <tr> 
