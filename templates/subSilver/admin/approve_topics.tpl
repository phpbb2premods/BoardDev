        ...
        <tr>
          <td width="100%" valign="top" align="center"> 
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0" class="forumline">
              <tr> 
                <th width="100%" nowrap class="thHead"><div align="center">{L_AWAITING_APPROVAL}</div></th>
              </tr>
              <tr> 
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0" class="forumline">
              <tr> 
                <th width="100%" nowrap class="thHead"><div align="center">{L_MODERATED_TOPICS}</div></th>
              </tr>
              <tr> 
                <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr> 
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0" class="forumline">
              <tr> 
                <th width="100%" nowrap class="thHead"><div align="center">{L_AUTO_APPROVED_TOPICS}</div></th>
              </tr>
              <tr> 
                <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr> 
