...
* @version $Id: qpes.php,v 1.7 29/03/2006 15:52 reddog Exp $
...
if ( !( ( !$is_auth['auth_reply'] || $forum_topic_data['forum_status'] == FORUM_LOCKED || $forum_topic_data['topic_status'] == TOPIC_LOCKED ) && $userdata['user_level'] != ADMIN ) )
{
	...
	// check attach sig
	$hidden_form_fields .= (($qp_lite || !$qp_lite && !$qp_more) && $attach_sig) ? '<input type="hidden" name="attach_sig" value="' . $userdata['user_attachsig'] . '" />' : '';
