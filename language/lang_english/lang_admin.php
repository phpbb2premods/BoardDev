...
$lang['Optimize_20seconds'] = "20 secondes (seulement pour test)";
...
$lang['Optimize_Show_begin_for'] = 'Monter les tables commençant par';
$lang['Optimize_Show_not_optimized'] = 'Il montre tableaux n\'optimisés pas seuls';
...
$lang['Optimize_return'] = 'Veuillez cliquer %sIci%s pour retourner à l\'optimisation de la base de données';
...
$lang['Confirm_delete_smiley'] = 'Êtes-vous sûre de vouloir supprimer ce smilie ?';
...
$lang['User_allowavatar'] = 'Avatar approuvé';
...
// MOD ColorText
$lang['Allow_colortext'] = 'Autoriser les Couleurs Personnalisées dans les Posts';
...
// Avatar Approve mod
$lang['Disable_avatar_approve'] = 'Désactiver le systeme d\'aprobation des avatars';
$lang['Avatar_posts'] = 'Nombre de message minimal pour avoir un avatar';
$lang['Avatar_posts_explain'] = 'Cela ne s\'applique pas dans la gallerie d\'avatars.';
//
// That's all Folks!
// -------------------------------------------------
...
$lang['Globalannounce'] ="Annonce globale";
...
$lang['Report_forum_explain'] = 'ID du forum où les utilisateurs posteront les rapports, une valeur de 0 désactivera cette option. Les utilisateurs DOIVENT au moins avoir les droits pour poster/répondre dans ce forum';
