...
// Start add - Multiple pseudos hunter MOD
$ip = ( $userdata['user_level'] != USER ) ? '&nbsp;&nbsp;&nbsp;<a href="' . append_sid("mph.$phpEx?" . POST_USERS_URL . "=" . $profiledata['user_id'] . "&amp;sid=" . $userdata['session_id']) . '" style="vertical-align:middle"><img src="' . $images['icon_ip'] . '" border="0" alt="' . $lang['View_IP'] . '" /></a>' : '' ;
// End add - Multiple pseudos hunter MOD

$template->assign_vars(array(
	'USERNAME' => $profiledata['username'],
	'JOINED' => create_date($lang['DATE_FORMAT'], $profiledata['user_regdate'], $board_config['board_timezone']) . $ip,
