...
if ( !empty($setmodules) )
{
	...
	$module[$lang['approve_admin_approval']][$lang['approve_admin_approve_index'].' '] = $file . "";
	$module[$lang['approve_admin_approval']][$lang['approve_admin_forum_moderation'].' '] = $file . "?mode=f";
	$module[$lang['approve_admin_approval']][$lang['approve_admin_post_moderation'].' '] = $file . "?mode=p";
	$module[$lang['approve_admin_approval']][$lang['approve_admin_topic_moderation'].' '] = $file . "?mode=t";
	$module[$lang['approve_admin_approval']][$lang['approve_admin_user_moderation'].' '] = $file . "?mode=u";
	return;
}
